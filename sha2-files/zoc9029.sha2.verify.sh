...
wget https://www.emtec.com/downloads/zoc/zoc9029.sha2
wget https://www.emtec.com/downloads/zoc/zoc9029.sha2.sig
...
cat zoc9029.sha2.sig

printf "\n\nVerifying the integrity of the file containing the SHA-2 values:\n"
openssl base64 -d -in zoc9029.sha2.sig -out zoc9029.sha2.bsig
openssl dgst -sha256 -verify sha2-public-key.pem -signature zoc9029.sha2.bsig zoc9029.sha2
